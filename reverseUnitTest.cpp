...
namespace {
    ...
    TEST(reverseTest, reverse) {
        ...
        reverse(arr_5, sizeof(arr_5) / sizeof(int32_t));
        ...
        reverse(arr_6, sizeof(arr_6) / sizeof(int32_t));
        ...
        reverse(arr_7, sizeof(arr_7) / sizeof(int32_t));
        ...
        reverse(arr_8, sizeof(arr_8) / sizeof(int32_t));
